...
#pragma omp target teams distribute parallel for simd map(x[0:jmax][0:imax], xnew[0:jmax][0:imax])
...
#pragma omp target teams distribute map(x[0:jmax][0:imax], xnew[0:jmax][0:imax])
